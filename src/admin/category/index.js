...
import {deleteCategory, fetchCategories} from "../../api/admin";
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Вы действиетльно хотите удалить Категорию?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button onClick={() => {
                ...
                actions={[
                    {
                        ...
                        tooltip: 'Добавить',
                        onClick: (e, r) => {
                            props.history.push('/admin/category-add-edit');
                        }
                    },
                    {
                        icon: () => <Edit />,
                        ...
                        onClick: (e, r) => {
                            ...
                            props.history.push(`/admin/category-add-edit?category_id=${r.id}`);
                        }
                    },
                    {
                        icon: () => <DeleteOutline />,
