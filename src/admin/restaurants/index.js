            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Вы действиетльно хотите удалить ресторан?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button onClick={() => {
                ...
                actions={[
                    {
                        ...
                        tooltip: 'Добавить',
                        onClick: (e, r) => {
                            props.history.push('/admin/restaurant-add-edit');
                        }
                    },
                    {
                        icon: () => <Edit />,
                        ...
                        onClick: (e, r) => {
                            ...
                            props.history.push(`/admin/restaurant-add-edit?restaurant_id=${r.id}`);
                        }
                    },
                    {
                        icon: () => <DeleteOutline />,
...
export default withRouter(AdminRestaurants);
